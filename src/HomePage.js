...
function HomePage() {
    return (
        <>
            ...
            >
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        ...
                        <p className="mb-5">
                            Our game selling website offers a diverse range of
                            the latest video games across all platforms at
                            competitive prices, providing a convenient and
                            hassle-free shopping experience for gamers.
                        </p>
                        <Link to="/about">
            ...
            <h1 className="text-3xl" id="Browse">
                &nbsp;&nbsp; Hot Games &gt;
            </h1>
